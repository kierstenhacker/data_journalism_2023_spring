...
**Answer: organizing each row by the term and adding the total number of courses for each term in the second column**
...
**Answer: We got by term the total number of classes, the total number of seats, the mean and median seats. It is similar to the previous code block in that it is arranged in descending order and grouped by term. It also counted classes and seats like above, but the mean and median number of seats are different in this code. **
