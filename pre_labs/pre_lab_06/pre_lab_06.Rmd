...
**Answer: Yes each of the csv files have the same column structure, especially for the counties which have the same header and values. They each have the same number of rows and columns in the same structure.**
...
**Answer: What stands out to me is that in 2016 there were fewer Democrats registered than Republicans but now since 2016 the number of registered Democrats has increased each year to surpass Republicans. Unaffiliated voters saw the second largest increase since 2016 compared to Democratic voters with about 13,000 more voters. The population of voters also increased heavily, which could show that a lot more people are moving to Frederick.** 
...
**Answer: There are 24 rows now and there should be 24 rows when it is a 1 to 1 join.**
...
**Answer: This data brings in different races of the population and the population of people 18 and over.** 
...
**Answer: Prince George's County has the highest 18+ Black population as a percentage of all population over 18 and the highest percentage of Democrats in a county.**
...
**Answer: The percentages are much lower than the previous results for the percentage of Asian adults above 18. Mostly Howard and Montgomery County have stronger percentages while the rest of the counties are much lower, unlike the results above.**
...
**Answer: The datatype is ZCTA5N is a dbl so it is a number.**
...
**Answer: Now the ZCTA5N column is a character rather than a dbl or number so we could join it with other zip code columns that are characters. When the datatypes are different, the columns cannot join.**
