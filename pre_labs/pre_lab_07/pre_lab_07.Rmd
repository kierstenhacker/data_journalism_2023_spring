...
**Answer: Howard County has the highest median income.**
...
**Answer: Howard County Wealthiest in Maryland, Calvert and Montgomery Follow** 
...
Is the difference between Calvert and Montgomery significant? **Answer: The difference between Calvert and Montgomery is not significant enough to know for sure that Calvert County has a higher median household income than Montgomery County. Since the arms overlap for the margin of error, it could be at a point where one county surpasses the other or falls behind the other and it is not an accurate representation of which county is higher because of that overlap.**

Is the difference between Howard and everyone else significant? **Answer: The difference with Howard County is more significant over the others, making it easier to decipher it as truly the county with the highest median income. Even with the margin of error, the median household income would still be higher than the other counties, verifying it as the top earning in the state. **
...
**Answer: Baltimore City, Allegany and Calvert counties saw the largest increases in median income with Frederick, Anne Arundel and Kent County following behind. The increase in Baltimore City could come as a surprise and likely would have gentrification to blame for it. None of the jurisdictions saw a decrease in median incomes from 2010-2021.**
...
**Answer: We could ask questions to see if enrollment and median household income are related, or, if there is correlation or causation between the two. We could start to see which schools may be better funded by zip code and why that may lead to more students attending college, since we saw that the wealthier schools have higher rates. It could be hard to interpret some of the answers to questions asked of the data since some students at the schools may be coming from a zip code different from their school's zip code. Therefore, the zip code of the school alone might not be the best representation of all students who attend the school, so results about wealth, funding or resources may not be exactly what they seem. Not all students may have the same experience or median incomes as zip code dictates the education students receive.**
...
**Answer: High schools with 60% or more graduates immediately enrolling in college have a higher average household income than high schools with less than 40% of graduates immediately enrolling in college. This could be due to a number of factors such as resources, culture around the expectation of college, other financial circumstances and several other things. **
...
**Answer: I would like to break down the data to look at enrollment in college for each county, seeing which schools have the highest percentage in each. Here, we might find outliers in each county or even a story about what makes those schools different from the rest of their county. I think it would then also be interesting to ask which county had the highest percentage of college enrollment, which I am assuming would be whichever counties are wealthiest, but there could be a surprising piece of information in there. I think it would also be worth asking more about the zip codes and if there are any zip codes that are not represented with a school but have students living in them. I know for example in my home school district there were students who attended the same schools as me but came from a zip code that did not have a school. I'm not sure if this is how this data works, but if it is, that would be something interesting to look into.** 
