...
**Answer: https://datawrapper.dwcdn.net/vIy3x/1/** Copy the url of the graphic you published here. It will begin with https://datawrapper.dwcdn.net/. Don't copy the browser's current url.
...
**Answer: The previous map showed us the percentage of votes won by Wes Moore in each county, but Maryland was so small on the map with all the other states that the counties weren't visible. So after hiding the other states without data, we now have a zoomed in map isolating the state of Maryland and allowing all counties and the data to be visible.** Describe the changes from the previous map
...
**Answer: Now when hovering over the different counties, the names of the counties appear rather than their fips code. Because we also changed the format of the percentages, now when hovering over the counties the percentages only have one decimal place and the percent sign. The previous map showed several decimal places with no percent symbol.** Describe the changes from the previous map
...
**Answer: https://datawrapper.dwcdn.net/138H7/1/** Put the URL of your map here.
