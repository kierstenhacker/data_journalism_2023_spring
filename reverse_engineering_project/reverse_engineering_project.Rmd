...
blk_women_shot_perc <- black_women_shot/women_shot_count
...
blk_women_comp_unarmed<- black_women_shot/unarmed_shot_count
```
### Sentence 5
...
dates <- as.POSIXct(date, format = "%m/%d/%Y %H:%M:%S")
